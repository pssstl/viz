...
ggplot(SKY, aes(x = Name, y = energy)) +
   geom_point() +
  coord_flip() +
  labs(x = "Participant",
...
ggplot(SKY, aes(x = Name, y = clarity_mind)) +
  geom_point() +
  coord_flip() +
    labs(x = "Participant",
       y = "Strongly Disagree - Strongly Agree",
...
ggplot(SKY, aes(x = Name, y = multiple_responsibilities)) +
  geom_point() +
  coord_flip() +
    labs(x = "Participant",
       y = "Strongly Disagree - Strongly Agree",
...
ggplot(SKY, aes(x = Name, y = connect_to_myself)) +
  geom_point() +
  coord_flip() +
    labs(x = "Participant",
       y = "Strongly Disagree - Strongly Agree",
...
ggplot(SKY, aes(x = Name, y = stay_focused)) +
  geom_point() +
  coord_flip() +
    labs(x = "Participant",
       y = "Strongly Disagree - Strongly Agree",
...
ggplot(SKY, aes(x = Name, y = remain_calm)) +
  geom_point() +
  coord_flip() +
    labs(x = "Participant",
       y = "Strongly Disagree - Strongly Agree",
...
ggplot(SKY, aes(x = Name, y = gain_resilience)) +
  geom_point() +
  coord_flip() +
    labs(x = "Participant",
       y = "Strongly Disagree - Strongly Agree",
...
ggplot(SKY, aes(x = Name, y = broader_perspectives)) +
  geom_point() +
  coord_flip() +
    labs(x = "Participant",
       y = "Strongly Disagree - Strongly Agree",
...
ggplot(SKY, aes(x = Name, y = connect_with_others)) +
  geom_point() +
  coord_flip() +
    labs(x = "Participant",
       y = "Strongly Disagree - Strongly Agree",
...
ggplot(SKY, aes(x = Name, y = good_investment_of_time)) +
  geom_point() +
  coord_flip() +
    labs(x = "Participant",
       y = "Strongly Disagree - Strongly Agree",
