---
title: "Happiness Retreat Outcome Survey"
output: 
...
--------
With the help of my reviewer, I was able to achieve this final plot. Looking at the previous versions, some of the unaesthetic visualization elements include: unnessasary axes descriptions, lack-of-detail title, color-blind unfriendly, x-y axis lines going over the bars, heavy cognitive load.
...
Sidebar Title {.sidebar}
--------
Version 1 was basically a `r emo::ji("poop")`-ty train-wrack. Later, a more presentatble visualization, a one without unnecessary load of cognition surfaced. 
...
Sidebar Title {.sidebar}
--------
Initially, I ploted all of participants responses into individual dotplots. Looing at them, I don't know how much information I gained. So, I decided to try the table. The final table has the approprate title and everything. A little victory. 
`r emo::ji("birthday")`
